...
VL_INLINE_OPT QData Vtop::_change_request(Vtop__Syms* __restrict vlSymsp) {
    ...
    __req |= ((vlTOPp->top__DOT__reset ^ vlTOPp->__Vchglast__TOP__top__DOT__reset)
	 | (vlTOPp->top__DOT__clk_3 ^ vlTOPp->__Vchglast__TOP__top__DOT__clk_3));
    VL_DEBUG_IF( if(__req && ((vlTOPp->top__DOT__reset ^ vlTOPp->__Vchglast__TOP__top__DOT__reset))) VL_DBG_MSGF("        CHANGE: top.sv:19: top.reset\n"); );
...
void Vtop::_ctor_var_reset() {
    ...
    __Vclklast__TOP____VinpClk__TOP__top__DOT__reset = VL_RAND_RESET_I(1);
